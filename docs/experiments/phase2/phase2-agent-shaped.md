...
|---|---|
| Heuristic v2 | 0.0566 |
| **Agent (Model #1)** | 0.1407 |
| Rollout | 0.2542 |

- The agent decides in **0.1407 ms** vs the rollout's **0.2542 ms** (**2x** faster), but captures only **0.0%** of the gap - the speed advantage is moot until it beats greedy.
