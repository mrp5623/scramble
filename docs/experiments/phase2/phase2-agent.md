...
|---|---|
| Heuristic v2 | 0.0648 |
| **Agent (Model #1)** | 0.1578 |
| Rollout | 0.2710 |

- The agent decides in **0.1578 ms** vs the rollout's **0.2710 ms** (**2x** faster), but captures only **0.0%** of the gap - the speed advantage is moot until it beats greedy.
